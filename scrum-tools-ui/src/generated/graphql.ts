...
export type JoinSessionMutation = { joinSession: Pick<EstimationMember, 'id' | 'joinedAt' | 'lastSeenAt' | 'name' | 'secret'> };
...
export type UpdateSessionMutation = { updateSession: Pick<EstimationSession, 'id' | 'joinSecret' | 'adminSecret' | 'name' | 'description' | 'defaultOptions'> };
...
export type EndVoteMutation = { endVote: (
    Pick<EstimationTopic, 'id' | 'endedAt'>
...
export type SessionOverviewFragment = (
  Pick<EstimationSession, 'id' | 'name' | 'description' | 'joinSecret' | 'adminSecret' | 'modifiedAt'>
  & { activeTopic?: Maybe<Pick<EstimationTopic, 'id'>>, members?: Maybe<Array<Pick<EstimationMember, 'id'>>> }
);

export type SessionDetailsFragment = (
  Pick<EstimationSession, 'id' | 'name' | 'description' | 'joinSecret' | 'adminSecret' | 'modifiedAt' | 'defaultOptions'>
  & { activeTopic?: Maybe<TopicDetailsFragment>, members?: Maybe<Array<SessionMemberFragment>>, topics?: Maybe<Array<TopicDetailsFragment>> }
);

export type SessionMemberFragment = Pick<EstimationMember, 'id' | 'lastSeenAt' | 'name'>;

export type TopicDetailsFragment = (
...
export type SessionUpdatedSubscription = { sessionUpdated: (
    Pick<EstimationSession, 'id' | 'name' | 'description' | 'joinSecret' | 'adminSecret' | 'modifiedAt'>
    & { activeTopic?: Maybe<Pick<EstimationTopic, 'id'>>, members?: Maybe<Array<SessionMemberFragment>>, topics?: Maybe<Array<TopicDetailsFragment>> }
  ) };
...
export const UpdateSessionDocument = gql`
    mutation updateSession($id: ID!, $adminSecret: String!, $joinSecret: String, $name: String, $description: String, $defaultOptions: [Int!]) {
